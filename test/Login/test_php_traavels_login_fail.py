...
class TestLoginForm:
    ...
    @pytest.mark.parametrize("usernameEmail, password", 
                             excelfileReader.get_excel_data("C:/Users/Benjamin Saint Elien/Documents/FrameworkAnalysis_2/virtual_env/ExcelFiles/Login/PHP_Travels_LoginForm_Fail.xlsx", "RandomInfo"))
